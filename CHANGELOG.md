...
- Add security note for X-Forwarded headers
- Update CHANGELOG for version 1.4.0
- Merge pull request #51 from nebhale/nebhale/path-prefix-reverse-proxies
- Support configurable reverse proxy paths
- Add Bambu printer support to README description
- updated screen shots and text
- updated screenshots
...
- set accent color to violet, instead of an exact orange match to spoolman
- first pass at new UI gated behind devmode
- Merge branch 'main' of https://github.com/sargonas/filabridge
- added tab preservation on reload to subtabs. This closes #34

## [v1.2.1] - 2026-07-31

### Other

- fix duplicate unassign requests and misleading unmap logging
